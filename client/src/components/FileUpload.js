    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `0dc8c7264d370a95c1c9`,
            pinata_secret_api_key: `114c3b76faeec456ef30d0cecdb0ed2548f65a9d0dadc80fc9e22f2b8d78816f`,
        ...
        // Updated code. Use the signer to send the transaction
